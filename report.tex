...
\begin{document}
	...
	Some effects/functions that were used are: 
	.Free Camera so that there can be any number of different viewpoints that can be achieved.
	.Loading in textures from downloaded sources.
	.Using transforms to correctly place my geometry.
